...
*May 2025 - Current* * Developing hardware-software co-design approaches for fully solid-state SP-LiDAR systems. 
* Modeling SP-LiDAR glare as a linear inverse problem and correcting artifacts via a training-free inversion process in the raw transient histogram domain. 
* Modeling and simulating SP-LiDAR to address robustness in low-SBR conditions. 

### **Intern (Contractor for USRA)** | Air Force Research Laboratories (Rome, NY) 
*Jun 2023 - Aug 2023* * Developed a novel hierarchical active sampling method utilizing a self-supervised approach to infer identifiable clusters. 
* Applied active learning to reduce the time required by human annotators to label datasets via a novel Active Learning Classification Method. 
